...
const { registerToko, getDataToko, getDetailCardToko, getDetailCardTokoFull, getPackageListStore, getDetailTokoPenyedia, cekTokoData, updateToko, deleteToko } = require('../controllers/Toko');
